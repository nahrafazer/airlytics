...
# Ambil salah satu estimator (misalnya pohon pertama)
...
plot_tree(
    ...
    filled=True,
    rounded=True,
    max_depth=3  # opsional: batasi kedalaman
)
plt.title("Visualisasi Salah Satu Pohon Keputusan (Random Forest)")
plt.tight_layout()

# Simpan ke file
plt.savefig("pohon_random_forest.png", dpi=300)  # bisa juga .pdf, .svg, dll
plt.show()
